...
BoundaryCraft is available through PayanAgent's x402 settlement route on Base mainnet.
...
The API is automated policy triage. It is not legal advice, a penetration test, a security
certification, or a guarantee that an action is safe.
